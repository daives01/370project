    ...
    while cap.isOpened():  # loop for each frame
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                new_gesture = finger_positions.detectPosition(hand_landmarks, results.multi_handedness[0].classification[
                    0].label)  # This will eventually be a DetectGesture() function, or something like that
